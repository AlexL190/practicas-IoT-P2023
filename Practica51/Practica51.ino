...
const char* ssid = "iNFINITUM37A4_2.4";
// your network password,
const char* pass = "f2mgsXEUM9";
WiFiClient client;
unsigned long myChannelNumber = 2319476; //SECRET_CH_ID;
const char* myWriteAPIKey = "FWYMA9OII32HOH0Y";
